...
| Monkey, Robot Explorer, Treasure Hunter, Tribal Adventurer, and Golden Explorer animated character GLBs | Authored in `tools/generate_playable_characters.py` for this project | Original project-authored output; no third-party license or attribution required | `res://assets/3d/characters/{monkey,robot,treasure,tribal,golden}/` | Low-poly playable skins with stable pivots, named part hierarchy, reusable materials, and nine animation clips matching `Player3D.gd`. |
| Upgrade, skating, and boat clothing overlays plus expedition canoe | Authored in `tools/generate_mode_equipment.py` for this project | Original project-authored output; no third-party license or attribution required | `res://assets/3d/outfits/`, `res://assets/3d/vehicles/canoe.glb` | Modular runtime equipment shared by all seven explorers; avoids duplicated full-character variants. |
| Modular one-, two-, and three-lane track GLBs | Authored in `tools/generate_track_assets.py` for this project | Original project-authored output; no third-party license or attribution required | `res://assets/3d/environment/tracks/` | 27 runtime track assets covering dirt, grass, mud, stone, wood, sand, skating, water-slide, and boat surfaces. |
| Monkey, Robot Explorer, Treasure Hunter, Tribal Adventurer, and Golden Explorer source-preview PNGs | Generated specifically for this project with the built-in OpenAI image generation workflow, using the Kairo/Zuri previews only as presentation-style references | Project-generated output; no third-party stock asset or attribution dependency | `res://assets/3d/characters/{monkey,robot,treasure,tribal,golden}/*_source_preview.png` | 1220×720 low-poly full-body character preview renders stored beside their GLBs. |
| Gem, bricks, wood, tiles, windows, food, tools, relic key, Sunstone shard, and map-piece resource icons | Generated specifically for this project with the built-in OpenAI image generation workflow; chroma background removed locally | Project-generated output; no third-party stock asset or attribution dependency | `res://assets/ui/icons/icon_gem.png`, `icon_bricks.png`, `icon_wood.png`, `icon_tiles.png`, `icon_windows.png`, `icon_food.png`, `icon_tools.png`, `icon_relic_key.png`, `icon_sunstone_shard.png`, `icon_map_piece.png` | Transparent 32×32 RGBA mobile HUD icons, produced as a consistent jungle-adventure set. |
| Sand Shoes, water token, fish token, river relic, animal badge, and trade token UI icons | Generated specifically for this project as original UI icon art | Project-generated output; no third-party stock asset or attribution dependency | `res://assets/ui/icons/sand_shoes_icon.png`, `water_token_icon.png`, `fish_token_icon.png`, `river_relic_icon.png`, `animal_badge_icon.png`, `trade_token_icon.png` | Transparent 32×32 RGBA PNG icons wired through `Constants.RESOURCES`, `Constants.UPGRADES`, `LevelComplete3D.gd`, and `LevelSelect.gd`. |
| Jump, slide, and land sound effects | Synthesized specifically for this project from procedural tones/noise | Project-generated output; no third-party sample or attribution dependency | `res://assets/sounds/jump.wav`, `slide.wav`, `land.wav` | 22050 Hz 16-bit mono WAV files for jump, slide, and landing feedback. |
